...
namespace SpellCombat {
    ...
    public class ChangeProbabilityHUDController : GeneralCombatHUDController, ISubscribeMethodsToEvents, IUnsubscribeMethodsToEvents {
        ...
        private const string _changeProbabilityDescription = "Alter the probability of changing the player's and enemy's wizard-type. When using it, you will have to wait 1 turn to use it again.";
